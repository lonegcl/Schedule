  ...
  return (
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
       <div className="flex items-start justify-between">
         <div>
           <h2 className="text-xl font-bold text-slate-900 tracking-tight mb-1.5">Review & Confirm</h2>
           <p className="text-[14px] text-slate-500">Please review all settings below. You can go back to any step to make changes.</p>
         </div>
       ...
       <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-2 max-w-[1200px]">
           ...
           {/* Basic Settings */}
           <div className="bg-white rounded-lg border border-slate-200 p-6 shadow-sm flex flex-col relative group">
               <div className="flex items-center justify-between mb-6">
                   ...
                   <button className="text-blue-600 text-sm font-semibold flex items-center gap-1.5 hover:underline opacity-0 group-hover:opacity-100 transition-opacity">
                      <Edit2 className="w-3.5 h-3.5" /> Edit
                   </button>
               </div>
               <div className="grid grid-cols-[140px_1fr] gap-y-4 text-[13px]">
                   <div className="text-slate-500 font-medium">Schedule Name</div>
                   <div className="text-slate-800 font-medium">Stüssy - Contractor Service Monthly<br/>Payment 2026</div>
                   <div className="text-slate-500 font-medium pt-1">Service Module</div>
                   <div className="text-slate-800 font-medium pt-1">Contractor / Monthly Payment</div>
                   <div className="text-slate-500 font-medium pt-1">Time Zone</div>
                   <div className="text-slate-800 font-medium pt-1">(GMT+07:00) Asia/Jakarta</div>
           ...
           <div className="bg-white rounded-lg border border-slate-200 p-6 shadow-sm flex flex-col relative group">
               ...
               <div className="grid grid-cols-[140px_1fr] gap-y-4 text-[13px]">
                   ...
                   <div className="text-slate-800 font-medium leading-relaxed">BIPO SD (Processor) Location,<br/>Client Company Location</div>
                   <div className="text-slate-500 font-medium pt-1">Working Days</div>
                   <div className="text-slate-800 font-medium pt-1">Mon, Tue, Wed, Thu, Fri</div>
                   <div className="text-slate-500 font-medium pt-1">Weekend Days</div>
                   <div className="text-slate-800 font-medium pt-1">Saturday, Sunday</div>
                   <div className="text-slate-500 font-medium pt-1">Holidays</div>
                   <div className="flex flex-col gap-1 items-start pt-1">
                      <span className="text-slate-800 font-medium">2 holidays in 2026</span>
           ...
           <div className="bg-white rounded-lg border border-slate-200 p-6 shadow-sm flex flex-col relative group">
               ...
               <div className="grid grid-cols-[140px_1fr] gap-y-4 text-[13px]">
                   ...
                   <div className="text-slate-800 font-medium">12 months</div>
                   <div className="text-slate-500 font-medium pt-1">Configured</div>
                   <div className="text-slate-800 font-medium pt-1">4 months</div>
           ...
           <div className="bg-white rounded-lg border border-slate-200 p-6 shadow-sm flex flex-col relative group">
               ...
               <div className="grid grid-cols-[140px_1fr] gap-y-4 text-[13px]">
                   ...
                   <div className="text-slate-800 font-medium">4 of 5 tasks</div>
                   <div className="text-slate-500 font-medium pt-1">Auto Placing Request</div>
                   <div className="text-slate-800 font-medium pt-1">Base on the First Task Due Date</div>
                   <div className="text-slate-500 font-medium pt-1">Placing Request Date</div>
                   <div className="text-slate-800 font-medium pt-1 leading-relaxed">2 working days before first task due<br/>date at 14:00</div>
               </div>
           </div>
           ...
           <div className="bg-white rounded-lg border border-slate-200 p-6 shadow-sm flex flex-col relative group">
               ...
               <div className="grid grid-cols-[140px_1fr] gap-y-4 text-[13px]">
                   ...
                   <div className="text-slate-800 font-medium">Enabled</div>
                   <div className="text-slate-500 font-medium pt-1">Total Contractors</div>
                   <div className="text-slate-800 font-medium pt-1">2 contractors</div>
                   <div className="text-slate-500 font-medium pt-1">Fee Currency</div>
                   <div className="text-slate-800 font-medium pt-1">Mixed (SGD, AUD)</div>
               </div>
           </div>
